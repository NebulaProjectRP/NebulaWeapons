...
SWEP.PrintName				= "Magnum Shooter"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM_Semi				= 265					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_magnum_shooter.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_magnum_shooter.mdl" -- Worldmodel path
...
-- NEBULA CUSTOM SETTINGS FOR MAGS
SWEP.data 				= {}
...
SWEP.IronSightsPos = Vector(4.768, -23, 3.5)
SWEP.IronSightsAng = Vector(1.56, 0, 0)
-- --------------------------------
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_magnum_shooter")
...
if self.Secondary.Nextregen <= CurTime()  and self:Ammo2() < 12 then 
...
local ent = ents.Create("sg_missileex")
