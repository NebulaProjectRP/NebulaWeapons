...
SWEP.PrintName = "Enchanted Thanatos Reaper"

SWEP.ViewModel = "models/weapons/tfa_cso/c_thanatos_9_asap.mdl"
SWEP.WorldModel = "models/weapons/tfa_cso/w_thanatos_9_asap.mdl"
