...
SWEP.Primary.Spread		= .0056					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .0028	-- Ironsight accuracy, should be the same for shotguns
