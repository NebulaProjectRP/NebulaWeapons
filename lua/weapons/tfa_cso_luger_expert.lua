...
SWEP.Category				= "TFA CS:O Pistols"
SWEP.Author				= "Anri"
SWEP.Spawnable				= true
...
SWEP.Primary.Spread		= .0057					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .00285	-- Ironsight accuracy, should be the same for shotguns
