...
SWEP.PrintName				= "J-4 UZI Akimbo"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_dualuzi_v6_asap.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_dualuzi_v6_b_asap.mdl" -- Worldmodel path
