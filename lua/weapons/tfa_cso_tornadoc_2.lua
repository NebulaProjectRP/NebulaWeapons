...
SWEP.PrintName				= "Tornado - Firestorm"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_tornado_c_asap.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_tornado_asap.mdl" -- Worldmodel path
...
SWEP.TracerName 		= "cso_tra_tornado_c_2" 	--Change to a string of your tracer name.  Can be custom.
