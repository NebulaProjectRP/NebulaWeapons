...
SWEP.VElements = {
	["nade"] = { type = "Model", model = "models/nebularp/grenade_base.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(-0.022, 1.069, 2.75), angle = Angle(180, 0, -7.974), size = Vector(0.884, 0.884, 0.884), color = Color(255, 0, 0), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["nade"] = { type = "Model", model = "models/nebularp/grenade_base.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.072, 2.431, 2.772), angle = Angle(-171.896, 74.039, 1.383), size = Vector(0.884, 0.884, 0.884), color = Color(255, 0, 0), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
