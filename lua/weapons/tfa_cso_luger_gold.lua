...
SWEP.Primary.Spread		= .00565					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .002825	-- Ironsight accuracy, should be the same for shotguns
