...
function EFFECT:Init(data)
    ...
    self.Magnitude = math.max(data:GetMagnitude() or 1, 1)
    self.Thickness = 12 * self.Magnitude
    local owent
...
local beamcol = table.Copy(Color(255, 100, 255))
local beamcol2 = Color(255, 100, 255, 255)
...
function EFFECT:Render()
    ...
    render.DrawSprite(endPos, 12, 12, Color(255, 50, 255, 255))
